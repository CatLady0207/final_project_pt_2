...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                ...
                names= 'Vehicle_Type',
                title="Total Expenditures by Vehicle Type during Recessions")
        

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemploy_rec= recession_data.groupby('Vehicle_Type')['Automobile_Sales'].mean()reset_index()
        R_chart3 = dcc.Graph(
            figure=px.bar(unemploy_rec,
                x='Vehicle_Type',
                y= 'Automobile_Sales',
